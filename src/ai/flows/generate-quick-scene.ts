...
const prompt = ai.definePrompt({
    ...
    prompt: `Você é um roteirista de comédia criativo. Com base na personalidade e no nicho do influenciador, e no tema da piada fornecido, crie uma cena curta e engraçada.
